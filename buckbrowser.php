...
$buckbrowser_server = array(
    ...
    'Company.delete'                      =>  function($params) { return BuckBrowser::load_model('User')->create($params); },
    'Company.get_all_bank_accounts'       =>  function($params) { return BuckBrowser::load_model('User')->create($params); },
    'Company.get_all_contacts'            =>  function($params) { return BuckBrowser::load_model('User')->create($params); },
    ...
    'BankAccount.create'                  =>  function($params) { return BuckBrowser::load_model('User')->create($params); },
    'BankAccount.read'                    =>  function($params) { return BuckBrowser::load_model('User')->create($params); },
    ...
    'Contact.create'                      =>  function($params) { return BuckBrowser::load_model('User')->create($params); },
    'Contact.read'                        =>  function($params) { return BuckBrowser::load_model('User')->create($params); },

...
$buckbrowser_server = array(
    ...
    'BankAccount.update'                  =>  function($params) { return BuckBrowser::load_model('BankAccount')->update($params); },
    'BankAccount.delete'                  =>  function($params) { return BuckBrowser::load_model('BankAccount')->delete($params); },
    ...
    'Contact.update'                      =>  function($params) { return BuckBrowser::load_model('Contact')->update($params); },
    'Contact.delete'                      =>  function($params) { return BuckBrowser::load_model('Contact')->delete($params); },
    'Contact.get_all_invoices'            =>  function($params) { return BuckBrowser::load_model('Contact')->get_all_invoices($params); },
